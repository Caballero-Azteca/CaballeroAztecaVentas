...
import com.brainstormideas.caballeroaztecaventas.models.Cliente;
import com.brainstormideas.caballeroaztecaventas.models.Pedido;
import com.brainstormideas.caballeroaztecaventas.models.PedidoFolio;
import com.brainstormideas.caballeroaztecaventas.models.Vendedor;
import com.brainstormideas.caballeroaztecaventas.tools.ImageConverter;
import com.brainstormideas.caballeroaztecaventas.tools.InternetManager;
import com.brainstormideas.caballeroaztecaventas.tools.ReportsGenerator;
import com.brainstormideas.caballeroaztecaventas.tools.SessionManager;
import com.brainstormideas.caballeroaztecaventas.tools.TemplatePDF;
...
import com.google.firebase.database.core.utilities.tuple.PathAndId;
...
public class Menu_final extends AppCompatActivity {
    ...
    public void enviarPedido() {
        ...
        String currentDateTimeString = DateFormat.getDateTimeInstance().format(new Date());
        reporte = new ReportsGenerator(this, obtenerCliente(), Pedido.getVendedor(), obtenerListaDePedidos(), currentDateTimeString, ic.convertirImagen(imagen));
        try {
